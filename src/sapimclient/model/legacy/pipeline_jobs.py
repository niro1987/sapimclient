...
from ._base import LegacyPipelineJob
...
class _PipelineRunJob(LegacyPipelineJob):
...
class _ImportJob(LegacyPipelineJob):
...
class ResetFromValidate(LegacyPipelineJob):
...
class XMLImport(LegacyPipelineJob):
